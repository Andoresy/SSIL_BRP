...
def argparse_train_SSIL():
    parser = argparse_common()
    #Model Directory
    parser.add_argument('-mp', '--model_path', type=str, default = "rBRP_IL.pt", help="Model path, note that it should be in train/pre_trained/~.")
    #Training Parameter
    parser.add_argument('-b', '--batch', type=int, default = 256, help='batch size')
    parser.add_argument('-bv', '--batch_verbose', type=int, default = 100, help='batch verbose size')
...
def argparse_test():
    ...
    parser.add_argument('-mp', '--model_path', type=str, default = "rBRP_IL_SSIL.pt", help="Model path, note that it should be in train/pre_trained/~.")
