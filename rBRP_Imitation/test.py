...
if __name__ == '__main__':
    ...
    model_path = f"rBRP_Imitation/train/pre_trained/{args.model_path}"
    ...
    if args.test_all:
        if decode_type == 'greedy':
            ...
            #Ts = [1]*21 #Default
            Ts = [1,3,2,5,2,2,4,2,3,4,5,4,4,4,4,3,3,3,2,2,2] #Use this in rBRP_SSIL model for reproductivity
            test_sampling_all(device, model, args.seed, args.batch, args.sampling_num, is_ESS, Ts)
    else:    
        if decode_type == 'greedy':
